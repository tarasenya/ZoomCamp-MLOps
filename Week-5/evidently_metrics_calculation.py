...
from evidently.metrics import ColumnDriftMetric, DatasetDriftMetric, DatasetMissingValuesMetric, \
    ColumnDistributionMetric, ColumnQuantileMetric
...
raw_data = pd.read_parquet('data/march_data.parquet')
...
def calculate_metrics_postgresql(curr, i):
    ...
    logging.info(f'col quantile {column_quantile}')
    print(f'col quantile {column_quantile}')
    curr.execute(
